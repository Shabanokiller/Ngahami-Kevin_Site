...
<body>
    ...
    <form id="form" method="POST" action="#">
        ...
        <div>
            ...
            <input type="datetime-local" name="date_arrivee" value="<?= $query['Date Arrivee'] ?>" id="Date Arrivee">
        </div>
        <div>
            <Label for ="Date Depart">Date Arrivee</label>    
            <input type="datetime-local" name="date_depart" value="<?= $query['Date Depart'] ?>" id="Date Depart">
        </div>
        <div>
